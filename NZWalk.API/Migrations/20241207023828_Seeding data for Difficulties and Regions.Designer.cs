...
namespace NZWalk.API.Migrations
{
    ...
    [Migration("20241207023828_Seeding data for Difficulties and Regions")]
            ...
            modelBuilder.Entity("NZWalk.API.Models.Domain.Difficulty", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("dcf30041-2eae-4235-a35c-b8161de46744"),
                            Name = "Easy"
                        },
                        new
                        {
                            Id = new Guid("5d53da14-17c6-4037-91f8-67d2262f90a8"),
                            Name = "Medium"
                        },
                        new
                        {
                            Id = new Guid("037bdaf9-b7a9-45f6-9f70-1997179da56f"),
                            Name = "Hard"
                        });
                });
