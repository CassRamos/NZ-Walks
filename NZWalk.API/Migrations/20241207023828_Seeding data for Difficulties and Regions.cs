    ...
    public partial class SeedingdataforDifficultiesandRegions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("037bdaf9-b7a9-45f6-9f70-1997179da56f"), "Hard" },
                    { new Guid("5d53da14-17c6-4037-91f8-67d2262f90a8"), "Medium" },
                    { new Guid("dcf30041-2eae-4235-a35c-b8161de46744"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("037bdaf9-b7a9-45f6-9f70-1997179da56f"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("5d53da14-17c6-4037-91f8-67d2262f90a8"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("dcf30041-2eae-4235-a35c-b8161de46744"));
